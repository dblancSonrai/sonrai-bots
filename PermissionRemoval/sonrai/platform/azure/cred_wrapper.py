...
class CredentialWrapper(BasicTokenAuthentication):
    def __init__(self, credential=None, audience="https://management.azure.com/.default", **kwargs):
        ...
        :param str audience: The scope to use to get the token (default ARM)
        """
        super(CredentialWrapper, self).__init__(None)
        if credential is None:
            credential = DefaultAzureCredential()
        self._credential = credential
        self._policy = BearerTokenCredentialPolicy(credential, audience, **kwargs)
